/// DISCALIMER (OF SORTS...)
///    'Stage' was one of the very first parts I implemented in this project, and as
///      such, there are quite a few inadvisible/illogical things done here that
///      I since changed for most other parts of the game. As a starter, for some
///      reason I stuck the logic to make the stage zoom in overtime inside its 'draw'
///      function, which is clearly illogical. Also, I include the ability to pass
///      color vertex data along with position, but color is unused typically.
...
Stage::Stage() : GameEntityManager() {
    ...
    //Have the stage initialize its generator from its template
