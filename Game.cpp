...
Game::Game(MonitorData & mPtr) {
    ...
    //////////////////////////////////////////////////////////////////////
    ///  SOUND EFFECT DEBUG CODE     (DELETE THIS CODE ONCE WORKING!)
   // std::unique_ptr<SoundEffect> testSound = std::make_unique<SoundEffect>("/Users/forrestmiller/Desktop/xcode_test_projects/Star Suzerian/WAV_Files/Pulse_gun_01.wav");
    
    //testSound->addSound("/Users/forrestmiller/Desktop/xcode_test_projects/Star Suzerian/WAV_Files/Pulse_gun_01.wav");
    
//    std::cout << "\n\n\n\n\nCreated a testSound...\n";
//    std::cout << "Test sound has valid filepath: " << testSound->checkIfHasAValidFilepath() << "\n";
//    std::cout << "Test sound has multiple buffers: " << testSound->checkIfHasMultipleBuffers() << "\n";
//    std::cout << "hasName: " << testSound->checkIfHasName() << "\n";
//    std::cout << "TestSound is valid: " << testSound->checkIsValid() << "\n";
//    std::cout << "Number of buffers: " << testSound->getNumberOfBuffers() << "\n";
//
//    std::cout << "Error: " << testSound->error() << "     and first buffer number is: " << testSound->getFirstBuffer() << std::endl;
//
//
//    std::cout << "\nYup!!\n\n\n\n";
    ///  END SOUND EFFECT DEBUG CODE!
    //////////////////////////////////////////////////////////////////////
